...
一个用于分析清理由于弃用节点而不再使用的“孤儿模型”，帮助释放磁盘空间。ComfyModelCleaner V2.0 提供了更多的智能模型分析引擎，希望能够更精确地识别未使用的模型文件。
...
2. 克隆此仓库：
   ```bash
   git clone https://github.com/your-username/ComfyModelCleaner.git
   ```
